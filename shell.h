...
/**
 * struct builtin_s - defines the built-in commands
...
/**
 * struct alias_s - A new struct alias
 * @name: The alias.
...
int hell_exit(char **args, char **front);
...
int hell_alias(char **args, char __attribute__((__unused__)) **front);
